#ifndef ONLINEMUSICLISTFILLER
#define ONLINEMUSICLISTFILLER

#include "network.h"
#include "commander.h"
class OnLineMusicListFiller : public Commander
{
    QVector<bool> FillLOnlineMusicList(QTableWidget *pTable, const QString &query)
    {
